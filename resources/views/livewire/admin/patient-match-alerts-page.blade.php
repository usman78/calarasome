<div class="mx-auto w-full max-w-7xl space-y-6">
    ...
    <div class="rounded-xl border border-zinc-200 bg-white p-4 shadow-xs dark:border-zinc-800 dark:bg-zinc-950">
        <div wire:loading.flex wire:target="clinicFilter,markResolved" class="mb-3 items-center gap-2 rounded-lg bg-zinc-100 px-3 py-2 text-xs text-zinc-600 dark:bg-zinc-800 dark:text-zinc-300">
            ...
            <table class="min-w-full text-sm">
                <thead>
                    <tr class="border-b border-zinc-200 text-left text-zinc-600 dark:border-zinc-700 dark:text-zinc-300">
                        ...
                        <th class="px-3 py-2 font-medium">Existing IDs</th>
                ...
                <tbody>
                    @forelse ($alerts as $alert)
                        <tr class="border-b border-zinc-100 align-top dark:border-zinc-800">
                            <td class="px-3 py-2 text-zinc-700 dark:text-zinc-200">{{ $alert['created_at'] }}</td>
                            <td class="px-3 py-2 text-zinc-700 dark:text-zinc-200">{{ $alert['clinic_name'] }}</td>
                            ...
                            <td class="px-3 py-2 text-zinc-700 dark:text-zinc-200">{{ $alert['email'] ?: 'n/a' }}</td>
                            <td class="px-3 py-2 text-zinc-700 dark:text-zinc-200">{{ $alert['alert_type'] }}</td>
                            <td class="px-3 py-2 text-zinc-700 dark:text-zinc-200">
