...
| F-14 Failed T-7 Auth Handling | `database/migrations/2026_03_13_090100_create_appointment_payments_table.php` | `payments:cancel-expired-grace`, `/api/stripe/webhook` | `tests/Feature/StripeWebhookTest.php` | Done |
| F-15 Cancellation Matrix | `database/migrations/2026_03_14_090000_add_cancellation_fields_to_appointment_payments.php` | `/api/public/appointments/{appointment}/cancel`, `/api/admin/appointments/{appointment}` | `tests/Feature/PaymentCancellationTest.php` | Done |
| F-16 No-Show Capture | `database/migrations/2026_03_14_090000_add_cancellation_fields_to_appointment_payments.php`, `database/migrations/2026_03_14_090100_add_no_show_count_to_patients.php` | `/api/admin/appointments/{appointment}/no-show` | `tests/Feature/NoShowCaptureTest.php` | Done |
| F-17 Waitlist Scoring | `database/migrations/2026_03_16_090000_create_waitlist_entries_table.php` | `/api/admin/waitlist/priority-breakdown`, `/api/public/clinics/{slug}/waitlist` | `tests/Feature/WaitlistPriorityTest.php`, `tests/Feature/WaitlistEntryCreationTest.php` | Done |
| F-18 Staggered Notifications | `database/migrations/2026_03_17_090000_create_waitlist_notifications_table.php`, `database/migrations/2026_03_17_090100_create_waitlist_notification_recipients_table.php` | `waitlist:notify`, `/waitlist/claim/{token}` | `tests/Feature/WaitlistNotificationFlowTest.php` | Done |
| F-19 Insurance Data at Booking | `database/migrations/2026_03_17_110000_create_insurance_verifications_table.php` | `/api/public/clinics/{slug}/appointments` | `tests/Feature/InsuranceBookingTest.php` | Done |
| F-20 Admin Verification Queue | `database/migrations/2026_03_17_110000_create_insurance_verifications_table.php` | `/admin/insurance-verifications` | `tests/Feature/InsuranceVerificationQueueTest.php`, `tests/Feature/UiPhaseTwoPagesTest.php` | Done |
| F-21 T-24h Scheduler (Standard Urgency) | `database/migrations/2026_03_17_110000_create_insurance_verifications_table.php` | `insurance:daily-summary` | `tests/Feature/InsuranceDailySummaryTest.php` | Done |
| F-26 Multi-Provider Dashboard | N/A | `/dashboard` | `tests/Feature/AdminDashboardPageTest.php` | Done |
| F-27 Dashboard Alert Banners | N/A | `/dashboard` | `tests/Feature/AdminDashboardAlertsTest.php` | Done |
| F-23 Shared Email Alerts + Merge Tool | `database/migrations/2026_03_24_120000_create_patient_merge_logs_table.php` | `/admin/patient-match-alerts` | `tests/Feature/PatientMergeTest.php` | Done |
